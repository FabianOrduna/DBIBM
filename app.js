...
/**We are commenting this out because of the workhshop**/
//Create database
...
app.get('/view_names',function(req, res){
	...
	request({
		...
		if (!error && response.statusCode === 200)
		{
			...
			const json2csvParser = new Json2csvParser({data: json_string_for_csv_conversion, fields: fields }, function(err, csv) {
